...
//    var_dump('<br>');
    ?>
        <tr>
            <td style="width: 30%;"><?php $imagepath="./".$row1['GoodImage'];$href="goodDetail.php?id=".$row1['GoodId']; echo "<a href='$href'><img class='img-circle' style='width: 50px;height: 50px;' src='$imagepath'></a>";echo $row1['GoodName'];?></td>
