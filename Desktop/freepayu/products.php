    ...
    <div class="row" style="margin-top: 20px;">
      ...
      <div class="panel panel-default">
            <div class="panel-body search-firstline">
                ...
                <ul>
                <ul>
          <li style="margin-right: 40px;<?php echo ($order=='default'||$order=='')?"font-weight:bolder":"";?>"><a href="products.php?order=default">默认排序</a></li>
                <li style="margin-right: 40px;<?php echo ($order=='timefromnew')?"font-weight:bolder":"";?>"><a href="products.php?order=timefromnew">按时间降序</a></li>
                <li style="margin-right: 40px;<?php echo ($order=='timefromold')?"font-weight:bolder":"";?>"><a href="products.php?order=timefromold">按时间升序</a></li>
                <li style="margin-right: 40px;<?php echo ($order=='pricefromhigh')?"font-weight:bolder":"";?>"><a href="products.php?order=pricefromhigh">价格高->低</a></li>
                <li style="margin-right: 40px;<?php echo ($order=='pricefromlow')?"font-weight:bolder":"";?>"><a href="products.php?order=pricefromlow">价格低->高</a></li>
                <li style="margin-right: 40px;<?php echo ($order=='soldfromhigh')?"font-weight:bolder":"";?>"><a href="products.php?order=soldfromhigh">销量高->低</a></li>
                <li style="margin-right: 40px;<?php echo ($order=='soldfromlow')?"font-weight:bolder":"";?>"><a href="products.php?order=soldfromlow">销量低->高</a></li>
</ul>
            </div>
        </div>
